...
Plant.prototype.grow = function(growth_particles)
{
    ...
    joint_part.geometry.applyMatrix( new THREE.Matrix4().makeTranslation( 0, cylinder_height/2, 0 ) );
    
    //    joint_part.geometry.applyMatrix( new
    //    THREE.Matrix4().makeTranslation( joint_base_width/2,
    //    cylinder_height/2, joint_base_width/2 ) );
